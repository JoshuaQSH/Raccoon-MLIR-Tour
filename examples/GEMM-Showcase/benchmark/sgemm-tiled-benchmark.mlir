...
func @main() {
  ...
  affine.for %ti = 0 to %reps {
    ...
    call @matmul_dragonpie(%A, %B, %C) : (memref<2088x2048xf32>, memref<2048x2048xf32>, memref<2088x2048xf32>) -> ()
  }
...
func @matmul_dragonpie(%arg0: memref<2088x2048xf32>, %arg1: memref<2048x2048xf32>, %arg2: memref<2088x2048xf32>) {
  affine.for %k = 0 to 5 {
    affine.for %i = 0 to 7 {
