...
func @main() {
  ...
  affine.for %ti = 0 to %reps {
    ...
    call @matmul_dragonpie(%A, %B, %C) : (memref<2088x2048xf64>, memref<2048x2048xf64>, memref<2088x2048xf64>) -> ()
  }
...
func @matmul_dragonpie(%arg0: memref<2088x2048xf64>, %arg1: memref<2048x2048xf64>,
          %arg2: memref<2088x2048xf64>) {
  "dragonpie.matmul"(%arg0, %arg1, %arg2) {
